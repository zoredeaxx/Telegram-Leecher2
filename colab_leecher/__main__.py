...
async def main():
    ...
    @bot.on_message(filters.command("dirleech") & filters.private)
    ...
    @bot.on_message(filters.command("ytleech") & filters.private)
    ...
    @bot.on_message(filters.create(isLink) & ~filters.photo)
    ...
    async def handle_options(client, callback_query):
        ...
        if data in ["normal", "zip", "unzip", "undzip"]:
            BOT.Mode.type = data
            await message.delete()
            await client.delete_messages(chat_id=message.chat.id, message_ids=message.reply_to_message_id)
            ...
            if data in ["convert-true", "convert-false"]:
                BOT.Options.convert_video = True if data == "convert-true" else False
    ...
    @bot.on_message(filters.command("setname") & filters.private)
    ...
    @bot.on_message(filters.command("zipaswd") & filters.private)
    ...
    @bot.on_message(filters.command("unzipaswd") & filters.private)
